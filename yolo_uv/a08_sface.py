...
parser.add_argument('--target', '-t', type=str, default='/home/aa/smart_city_2025/data/face/choi.jpg',
                    help='Usage: Set path to the input image 1 (target face).')
parser.add_argument('--query', '-q', type=str, default='/home/aa/smart_city_2025/data/face/01.jpg',
                    help='Usage: Set path to the input image 2 (query).')
parser.add_argument('--model', '-m', type=str, default='/home/aa/smart_city_2025/data/face_recognition_sface_2021dec.onnx',
...
if __name__ == '__main__':
    ...
    detector = YuNet(modelPath='/home/aa/smart_city_2025/data/face_detection_yunet_2023mar.onnx',
                     inputSize=[320, 320],
                     confThreshold=0.9,
                     nmsThreshold=0.3,
                     topK=5000,
